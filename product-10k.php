...
$sql = "SELECT product_id as id, name, price, badge FROM product WHERE type LIKE '%พระหลักหมื่น%' LIMIT $offset, $itemsPerPage";
$result = $conn->query($sql);

// SQL query to count total rows
$sqlCount = "SELECT COUNT(*) AS total FROM product WHERE type LIKE '%พระหลักหมื่น%'";
